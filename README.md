...
Inspired by https://github.com/nikitayadav19/HappyBirthdayGF ✨

---

## 🚀 Live Demo  
👉 [Click here to view the site](https://munai-das.github.io/HappyBirthdayWifey/)  
...
1. Clone the repo:  
   ```bash
   git clone git@github.com:munai-das/HappyBirthdayWifey.git
